...
class RiskEngine:
    ...
    def _assess_hydromet(
        ...
        notes = [
            ...
            "Compare structural sensor response with these drivers before using them as correlation evidence.",
        ]
        if anomaly_signals:
            notes.append(
                "Hydrometeorological statistical anomalies are recorded as context and do not enter the structural anomaly score."
            )
        if status != "FRESH":
